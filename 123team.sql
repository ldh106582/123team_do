...
select * from Person;
update Person set PersonPw = "1234" where PersonPw="234";

delete from person where personId="ehgus191";
...
delete from HospitalMember where personId ="ehgus191";
...
drop table hospital;
alter table hospital modify addr varchar(100);
...
ALTER TABLE HApllication ADD CONSTRAINT FOREIGN KEY(petId) references  pet(petId);
