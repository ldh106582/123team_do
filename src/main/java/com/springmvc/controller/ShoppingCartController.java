...
public class ShoppingCartController {
	...
	// 도현_장바구니를 생성하고 만약 장바구니에 동일한 제품이 있을 경우 갯수만 추가함.
	...
	public String CreateCart(@ModelAttribute("product") Product product, HttpServletRequest request) 
	{
		...
		// 도현_로그인 시 세션에 담았던 아이디를 활용하여 장바구니 조회함. 
	...
	// 도현_주문완료 페이지 POST의 경우 ORDERCONTROLLER에 있음
	@GetMapping("/readcart")
	...
	// 도현_카트에 있는 product를 개별적으로 삭제하는 함수
